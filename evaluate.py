...
if params.tgt_lang:
    logger.info("Evaluate cross-lingual wordsim...")
    evaluator.crosslingual_wordsim(to_log)
    logger.info("Evaluate word translation precision@k...")
    evaluator.word_translation(to_log)
    logger.info("Evaluate sentence translation(only for Europarl language)...")
    evaluator.sent_translation(to_log)  # Europarl data is None, return
